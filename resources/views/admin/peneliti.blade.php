               ...
               <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Daftar Data Eksternal User</h4>
                    <div class="card-header-action">
                    <a href="{{ url('/formpengguna') }}" class="btn btn-primary">Tambah Data</a>
                    </div>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <?php $no++ ?>
                          <tr>
                            ...
                            <td>{{$pengguna->nama}}</td>
                            <td>{{$pengguna->pendidikan}}-{{$pengguna->instansi}}</td>
                            <td>
                              <a href="{{ url('/detailpenggunaan'.'/'.$pengguna->id) }}" class="btn btn-info btn-action mr-1 fas fa-info-circle " data-toggle="tooltip" title="Detail"></a>
                            </td>
                            @endforeach
                          </tr>
                        </tbody>
