          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12 col-sm-12 col-lg-12">
                 <div class="card">
                  <form method="post" action="/bahan" class="needs-validation" >
                    {{csrf_field()}}
                    <div class="card-header">
                      <h4>Form Tambah Data Bahan</h4>
                    </div>
                    <div class="card-body">
                      <div class="form-group row">
                        <label class="col-sm-3 col-form-label" >Kode</label>
                        <div class="col-sm-9">
                          <input type="string" class="form-control" required="" name="kode">
                          @if($errors->has('nip'))
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <select class="form-control selectric" required="" name="jenis">
                            ...
                            <option value="Non Narkotik">Non Narkotik</option>
                          </select>
                          <div class="invalid-feedback">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="string" class="form-control" required="" name="nama">
                          <div class="invalid-feedback">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <select class="form-control selectric" required="" name="tempat_penyimpanan">
                            <option selected="selected"></option>
                            <option value="Ruang Bahan">Ruang Bahan</option>
                            <option value="Ruang Standar">Ruang Standar</option>
                          </select>
                          <div class="invalid-feedback">
                        ...
                        <label class="col-sm-3 col-form-label">Jumlah</label>
                          ...
                          <div class="form-row">
                            <div class="form-group col-md-6">
                              <input type="text" class="form-control" id="inputEmail4" name="jumlah">
                            </div>
                            <div class="invalid-feedback">
                      ...
                      <!-- <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="string" class="form-control" required="" name="harga">
                          <div class="invalid-feedback">
                            Harga bahan harus dimasukkan
                          </div>
                        </div>
                      </div> -->
