      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="{{ url('/user') }}" class="nav-link"><i data-feather="user"></i><span>Internal User</span></a>
            </li>
            <li class="dropdown">
              <a href="{{ url('/pengguna') }}" class="nav-link"><i data-feather="users"></i><span>Eksternal User</span></a>
            </li>
            <!-- <li class="dropdown">
              <a href="/pengguna" class="nav-link"><i data-feather="book"></i><span>Logbook</span></a>
            </li> -->
            <li class="dropdown">
          ...
          <div class="section-body">
            <div class="row">
               <div class="col-12 col-sm-12 col-lg-12">
                 <div class="card">
                  <form class="needs-validation" novalidate="" method="post" action="/updatepass">
                        @csrf
                    ...
                    <div class="card-body">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          ...
                          <span class="help-block"><font color="red">Password tidak cocok</font></span>
                          @endif
